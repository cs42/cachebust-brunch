  ...
  module.exports = Cachebust = (function() {
    class Cachebust {
      constructor(config) {
        ...
        this.config = config;
        this.options = ((ref = this.config) != null ? (ref1 = ref.plugins) != null ? ref1.cachebust : void 0 : void 0) || {};
      ...
      onCompile(generatedFiles) {
        ...
        if (this.config.optimize) {
          this.targets.forEach((target) => {
            return generatedFiles.forEach((generatedFile) => {
      ...
      replaceContent(hashedFiles) {
        var content, refFile, references;
        references = this.options.reference || ['index.html'];
